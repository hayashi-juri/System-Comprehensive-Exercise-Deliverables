...
def read_raw_pressure(self):
    """Reads the raw (uncompensated) pressure level from the
    sensor."""
    self._write_byte(BMP180_CONTROL, BMP180_READPRESSURECMD +
    (self._mode << 6))
...
def read_altitude(self, sealevel_pa=101325.0):
    ...
    altitude = 44330.0 * (1.0 - pow(pressure / sealevel_pa,
    (1.0/5.255)))
    return altitude
